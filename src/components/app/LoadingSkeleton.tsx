interface LoadingSkeletonProps {
  headerText: string;
  // "reading": the photo is still being prepared — header only, no cubes yet.
  stage?: "reading" | "thinking";
}

export default function LoadingSkeleton({ headerText, stage = "thinking" }: LoadingSkeletonProps) {
  return (
    <div className="flex flex-col gap-3">

      {/* Header row: gold pulsing dot + text */}
      <div role="status" aria-live="polite" className="flex items-center gap-2 px-1 py-1 text-sm text-text-muted">
        <span
